namespace Satis.Entities.Migrations
{
    using System;
                ...
                c => new
                    {
                        ...
                        OzelKodu1 = c.String(maxLength: 30),
                        OzelKodu2 = c.String(maxLength: 30),
                        OzelKodu3 = c.String(maxLength: 30),
                        OzelKodu4 = c.String(maxLength: 30),
                        VergiDairesi = c.String(maxLength: 30),
                        VergiNo = c.String(maxLength: 15),
                        IskontoOrani = c.Decimal(nullable: false, precision: 5, scale: 2),
                        RiskLimiti = c.Decimal(nullable: false, precision: 15, scale: 2),
                ...
                c => new
                    {
                        ...
                        IndırımOrani = c.Decimal(nullable: false, precision: 5, scale: 2),
                        IndirimTutari = c.Decimal(nullable: false, precision: 12, scale: 2),
                        ToplamTutar = c.Decimal(nullable: false, precision: 12, scale: 2),
                        DepoKodu = c.String(maxLength: 12),
                        DepoAdi = c.String(maxLength: 30),
                        SeriNo = c.String(maxLength: 300),
                        Tarih = c.DateTime(nullable: false),
                        Aciklama = c.String(maxLength: 200),
                    })
                .PrimaryKey(t => t.Id);
